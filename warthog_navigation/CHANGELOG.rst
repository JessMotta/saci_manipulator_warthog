^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for packagewarthog_navigation
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

0.4.5 (2020-10-01)
------------------
* Expose the scan_topic argument in amcl_demo and gmapping_demo, make them use the WARTHOG_LASER_TOPIC env var as their default
